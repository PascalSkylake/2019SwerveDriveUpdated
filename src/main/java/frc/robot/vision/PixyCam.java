...
public class PixyCam {
    private static ArrayList<Pixy2CCC.Block> blocks = new ArrayList<>();
    ...
    public static ColorBlock averageDupBlocks(ArrayList<Integer> sigs, ArrayList<Pixy2CCC.Block> blocks) {
